...
set num_row 2 
#num_row * num_row will be the number of nodes
set time_duration 5 
#duration of the actual simulation after initialization is done
...
#CREATE UDP SENDERS AND 1 NULL RECEIVERS (FOR UDP)
for {set i 0} {$i < [expr $num_row*$num_row] } {incr i} {
...
$ns_ attach-agent $node_([expr $num_row*$num_row/2]) $null_(0) 
#ONLY ONE BASE STATION

# CREATE THE ACTUAL FLOW (LOGICAL FLOW)
for {set i 0} {$i < [expr $num_row*$num_row]} {incr i} {
...
#CREATE 4 CBRs
for {set i 0} {$i < [expr $num_row*$num_row]} {incr i} {
    set cbr_($i) [new Application/Traffic/Pareto]
